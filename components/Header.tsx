...
const Header = () => {
  ...
  return (
    <div className='h-24 w-full md:grid md:grid-cols-5 lg:grid-cols-3 flex md:items-end items-center justify-between text-lg z-50 md:px-10 px-5 pb-2 leading-0'>
